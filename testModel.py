...
k1 = 'testModel/000018.jpg'
k2 = 'testModel/002689.jpg'
k3 = 'testModel/005525.jpg'
testImg = {'000018.jpg':cv2.imread(k1),'0002689.jpg':cv2.imread(k2),'005525.jpg':cv2.imread(k3)}
...
if testImg.values():
    ...
    with tf.Session() as sess:
        ...
        for key,img in testImg.items():
            #img preprocess
            resized = cv2.resize(img.astype(np.float), (227, 227)) - imgMean # resize automatically changes the size
            maxx = np.argmax(sess.run(softmax, feed_dict = {x: resized.reshape((1, 227, 227, 3))}))
            res = caffe_classes.class_names[maxx] # caffe_classes is result and npy is parameter
